...
export const pageRoutes = [
  ...
  { path: '/changelog', component: 'Changelog', title: 'Changelog - Coherent.js', props: { entries: loadChangelog(join(repoRoot, 'CHANGELOG.md'), { rewriteLinks: (html) => rewriteDocLinks(html, '') }) }, description: 'Release notes and version history for Coherent.js.' },
];
