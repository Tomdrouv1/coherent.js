      ...
      children: [
        {
          head: {
            children: [
              ...
              { script: { src: 'https://cdnjs.cloudflare.com/ajax/libs/prism/1.29.0/components/prism-core.min.js', defer: true } },
              { script: { src: 'https://cdnjs.cloudflare.com/ajax/libs/prism/1.29.0/plugins/autoloader/prism-autoloader.min.js', defer: true } },
