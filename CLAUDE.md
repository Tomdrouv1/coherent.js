...
- **`@coherent.js/state`** - Reactive state containers, observables, persistence, validation, and the SSR context API (`provideContext` / `useContext` / `createContextProvider`)
