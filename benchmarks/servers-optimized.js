import { createHttpServer, createExpressServer, createCoherentServer } from './benchmark-optimized.js';

console.log('Starting optimized servers...');
...
const server3 = createCoherentServer().listen(7003, () => {
  console.log('Coherent.js API (Optimized) listening on port 7003');
});

console.log('All optimized servers started. Press Ctrl+C to stop.');
